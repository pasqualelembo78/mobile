...
RCT_EXPORT_METHOD(generateRingSignatures:(NSString *)prefixHash
    ...
    bool result = generateRingSignaturesIOS(
        cppPrefixHash,
        cppKeyImage,
        cppPublicKeys,
...
RCT_EXPORT_METHOD(checkRingSignature:(NSString *)prefixHash
    ...
    bool result = checkRingSignatureIOS(
        cppPrefixHash,
        cppKeyImage,
        cppPublicKeys,
        cppSignatures
...
RCT_EXPORT_METHOD(generateKeyDerivation:(NSString *)publicKey
    ...
    bool success = generateKeyDerivationIOS(cppPublicKey, cppPrivateKey, cppDerivation);
...
RCT_EXPORT_METHOD(generateKeyImage:(NSString *)publicKey
    ...
    try {
        std::string keyImage = generateKeyImageIOS(cppPublicKey, cppPrivateKey);
...
RCT_EXPORT_METHOD(deriveSecretKey:(NSString *)derivation
    ...
    try {
        std::string secretKey = deriveSecretKeyIOS(cppDerivation, cppOutputIndex, cppPrivateKey);
...
RCT_EXPORT_METHOD(derivePublicKey:(NSString *)derivation
    ...
    try {
        // Call the C++ function
        int result = derivePublicKeyIOS(cppDerivation, cppOutputIndex, cppPublicKey, cppOutPublicKey);
...
RCT_EXPORT_METHOD(cn_fast_hash:(NSString *)input
                  resolver:(RCTPromiseResolveBlock)resolve
                  rejecter:(RCTPromiseRejectBlock)reject) {
    ...
    try {
        std::string cppHash = cn_fast_hash_IOS(cppInput);
